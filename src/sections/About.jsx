  ...
  return (
    ...
    >
      ...
      <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
        {/* Intro */}
        <div className="grid-container card-tilt h-full">
          <img
        ...
        <div className="grid-container card-tilt h-full">
          <div
            ref={globeRef}
            className="rounded-3xl w-full sm:h-[276px] h-fit flex justify-center items-center"
            aria-hidden="true"
          >
        ...
        {/* Passion */}
        <div className="grid-container card-tilt xl:col-span-3 md:col-span-2">
          <img
